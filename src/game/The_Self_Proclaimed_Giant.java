        ...
        if (question.equals("y") || question.equals("yes")){
            ...
            if (option1 == 1){
                ...
                if (option2A == 1){
                    ...
                    System.out.println("3. Just walk away.");
                    ...
                    if (option3A == 1){
                        ...
                        if (option4A == 1){
                            ...
                            if (option5A == 1) {
                                System.out.println("You hit her with the force of a thousand suns and sprint faster than humanly possible.");
                                ...
                                if (option6A == 1){
                                    ...
                                    System.out.println("You get down on the ground and sometime passes.");
                                    System.out.println("You and your case are pending which lawyer do you hire.");
                                    ...
                                    if (option7A == 1){
                                        ...
                                        System.out.println("A witness reports that out of nowhere you hit the victim with the force of a thousand suns.");
                                ...
                                int option12A = scan.nextInt();
                                if (option12A == 1) {
                                    System.out.println("You feel happy with the life you made with superior height.");
                                    System.out.println("You go to hug your wife but all of a sudden you shrink back to being a dwarf.");
                                    System.out.println("She sees you and screams that you were lying and were secretly 5'3 or shorter.");
                                    System.out.println("Ending:\n       Dwarf Out The Bag");
                                }
                                else{
                                    System.out.println("No you can do better in life and be happier.");
                                    System.out.println("You pack everything you can and run.");
                                    System.out.println("In hopes of a life that is far better than current.");
                                    System.out.println("Ending:\n       Free Dwarf");
                                }
                            }
                        }
                        else{
                            System.out.println("You think it was funny but bragging about it led to you being disliked.");
                            System.out.println("No more people and came up to talk to you leading you to live lonely..");
                        ...
                        if (option3A == 2){
                            ...
                            System.out.println("You burst down into tears and curl up into a ball.");
                            System.out.println("Screaming to people to get away the girl runs away calling you a freak.");
                            System.out.println("Ending:\n       Short Tempered Freak");
                        }
                        else{

                           AdventureGame.sp.playSound("duck.wav");
                            System.out.println("You decide its to much pressure so you turn around and just leave");
                            System.out.println("Ending:\n       Waddled Away");
                        }
                    }
                }
                else{
                    System.out.println("You yell and do your picture day smile to impress her.");
                    System.out.println("She pretends to speak a different language.");
                    System.out.println("You get upset following that a person comes up and turns out its her translator.");
                    System.out.println("She wasn't pretending and you feel super bad and decide to leave the mall.");
                ...
                if (option2B == 1){
                    ...
                    if (option3B == 1){
                        System.out.println("You accept and now you're a pro you hope someone will look up to you.");
                        ...
                        System.out.println("3. The unrealistic attempt");
                        ...
                        if (option4B == 1){
                            ...
                            if (option4B == 2) {
                                ...
                                System.out.println("You had no other choice you complete it and try your hardest to grab your shoes.");
                                System.out.println("You somehow even with the low odds you save it from falling.");
                                System.out.println("On completion the crowd goes wild your team cheers with glee.");
                                System.out.println("What you did became a well know move known as the Jumping Jordan.");
                                System.out.println("Ending:\n       Liar Reigns Victorious");
                            }
                        }
                    }
                    else{
                        ...
                        if (option6B == 1){
                            ...
                            if (option7B == 1){
                                ...
                                if (option8B == 1){
                                    ...
                                    System.out.println("You start a business where it teaches youth how to code.");
                            ...
                            System.out.println("You feel great shame greater than that of your low height you run out of the class.");
            ...
            System.out.println("Narrator: Jordan Eldridge.\nInspiration: Jordan Eldridge.\nSound: Xavier Cruz.");
            System.out.print("I have to give many thanks for Jordan being so cool with all of the jokes ");
            System.out.print("he has earned his credit even if its the short end of the deal.");
        }
    }
}
